...
No transfer learning - train end-to-end
"""
...
def parse_args():
    parser = argparse.ArgumentParser(description='Train 256³ from scratch on B200')
    ...
    parser.add_argument('--checkpoint_dir', type=str, default='checkpoints_direct256_scratch')
...
def main():
    ...
    # Create model
    print("Initializing 256³ model from scratch...")
